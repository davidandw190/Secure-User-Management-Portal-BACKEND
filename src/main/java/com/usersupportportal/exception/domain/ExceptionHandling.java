...
public class ExceptionHandling {
    ...
    private static final String ERROR_PROCESSING_FILE = "Error occurred while processing file";  // For file upload
    ...
    public ResponseEntity<HttpResponse> usernameExistException(UserExistException exception) {
        return createHttpResponse(BAD_REQUEST, exception.getMessage());
    }
